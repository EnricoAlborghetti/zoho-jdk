declare module "zoho-tdk" {
  namespace ZUtils {
    getEntitiyId: (entity: any) => string;
  }
  ...
  class ZSDK {
    ...
    getContext: () => {
      Model: {};
      Event: {
        Listen: (eventName: any, eventHandlerFn: any) => void;
        Trigger: (eventName: any, payload: any, isPromise: any) => any;
      };
      GetRequest: (options: any) => any;
      QueryParams: any;
      Translate: (key: any, options: any) => string | false;
    };
    OnLoad: (AppLoadHandler: any) => void;
    OnUnLoad: (AppUnLoadHandler: any) => void;
    OnContextUpdate: (AppCtxUpdateHandler: any) => void;
  }
  var ZSDKUtil: any;
  var ZSDKMessageManager: any;
  var ZSDKEventManager: any;
}
